    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="80">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <br>
                    <img src="img/Nattapoom_Founder.jpg" width="400" class="img-responsive" alt="Nattapoom Ratchayakorn">
                    <p class="text-center"><span class="colored-text">Nattapoom Ratchayakorn (Por)</span></p>
                </div>
                <div class="col-sm-7">
                    <!--<div class="col-sm-8 col-sm-offset-2">-->
            ...
            <div class="row">
                <div class="col-sm-12">                        
                    <p class="lead subtitle-center wow animated fadeIn" data-wow-delay=".1s" data-wow-delay=".1s">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><span class="colored-text">High level:</span></b> “Make It Better” is the philosophy of life. Newspective staff must be hungry to learn and be developed at all times to make their life better on a daily basis.<br>
