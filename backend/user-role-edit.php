      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <br>
            <button type="button" class="btn btn-success" onclick="checkval()"><span class="glyphicon glyphicon-floppy-disk"></span>  UPDATE</button>
            <button type="reset" value="Reset" class="btn" onclick="location.href='<?php echo $domainName;?>/backend/user-role-list.php'"><span class="glyphicon glyphicon-repeat"></span>  BACK</button>            
            <br>
            <div id="response"></div>
          </div>
        </div>
...
function send_form()
{
  ...
  if (window.XMLHttpRequest) {
    xmlHTTP_opp = new XMLHttpRequest();
        ...
        xmlHTTP_opp.open('GET', '<?php echo $domainName ?>/backend/user-role-update.php?' + str_param, true);
        xmlHTTP_opp.send(); 
