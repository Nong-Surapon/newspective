...
for($i=1;$i<=(int)($_POST["count"]);$i++)
    {
            ...
            if($file_name != "")
            {
                ...
                $f_rename = $pj_code."_".$i.".".$f_name['1'];
                
                $amount2 =$_POST["amount2_".$i];
        
                    if(move_uploaded_file($_FILES["file_".$i]["tmp_name"],"advance_photo/".$f_rename))
                    {
                        $mysqli->query("UPDATE tb_project_detail SET amount2='$amount2',file_name='$f_rename'  where pj_code='$pj_code' and seq='$i' ");
                    }
            }
    }
    ...
    <body>
        <table width='650' border='0' cellspacing='0' cellpadding='5'>
            <tr>
              <td colspan='2' align='left' valign='top'><p><a href='http://www.newspective.co.th/'><img src='http://newspective.co.th/backend/image/newspective-logo-email.gif' alt='Newspective.co.th' width='185' height='80' border='0' align='right'></a>              
            ...
            <tr>
              ...
              <td align='left' valign='top' class='detail'><p><a href='$domainName/backend/advance-sts-2.php?id=$pj_code'>เว็บไซต์ คลิกที่นี่</a></p></td>
            </tr>
            <tr>
