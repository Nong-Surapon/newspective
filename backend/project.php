...
<body id="aThis">
  ...
  <div class="container">
    ...
    <legend>สร้างโครงการใหม่</legend>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <br>
            <button type="button" class="btn btn-warning" onclick="checkval()">สร้างข้อมูล</button>
...
function send_form()
{
  ...
  if (window.XMLHttpRequest) {
    xmlHTTP_opp = new XMLHttpRequest();
        ...
        str_param = 'project=' + project + '&detail=' + detail + '&logNme=' + logNme + '&status=' + status ;


        xmlHTTP_opp.open('GET', '<?php echo $domainName ?>/backend/project-add.php?' + str_param, true);
        xmlHTTP_opp.send(); 
        //alert(str_param);
...
$("#aThis a:contains('สร้างโครงการใหม่')").parent().addClass('active');
</script>
