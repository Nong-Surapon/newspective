      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            ?>
            <div class="row">
            <div class="col-md-<?php if($salary["salary"]==0){echo "12";}else{ echo "10";}?>">
            <input type="text" class="form-control" maxlength="9" id="salary[]" name="salary[]" value="<?php if($salary["salary"]!="0"){ echo $salary["salary"];}?>" OnKeyPress="return checkInt(this.id)">
            ...
            <?php } ?>
            <label class="control-label salary" for="salary"><?php if($counS>0){ echo "เงินเดือน - เพิ่มเติม";}?></label>
            ...
            ?>
            <div class="row">
            <div class="col-md-<?php if($note["note"]==""){echo "12";}else{ echo "10";}?>">
            ...
            <a href="note_del.php?id=<?php echo $_GET["id"]?>&&seq=<?php echo $note['seq'];?>&&uid=<?php echo $user['uid']?>" class="btn btn-danger note" onclick="return confirm('Are you sure?')"><span class="glyphicon glyphicon-trash"></span></a>
                ...
                <?php } ?>
            <label class="control-label note" for="salary"><?php if($counN > 0){ echo "หมายเหตุ - เพิ่มเติม";}?></label>
