...
$portfolioQurery = portfolioQurery($_GET["id"]);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                            ...
                            <div class="blog-content">
                                <div class="entry-media">
                                    <div class="flexslider blog-slider">
                                        <ul class="slides ">
                                            <?php 
                                            $portfolioFile = portfolioFile($_GET["id"]);
                                                while ($row = $portfolioFile->fetch_assoc()) {     
                                            ?>
                                            <li>
                                                <img src="webadmin/file/portfolio/<?php echo $row['name']?>" alt="">
                                            </li><!--Single slide li-->
                                            <?php }?>
                        ...
                        <div class="sidebar-column">
                            ...
                            <div class="sidebar-widget">
                                ...
                                <ul class="list-unstyled latest-post">
                                    <?php
                                    $portfolioLast = portfolioLast($portfolioQurery["company"]);
                                        while ($rowLast = $portfolioLast->fetch_assoc()) { 
                                    
                                    ?>
                                    
                                    <li class="clearfix">
                                        <a href="portfolio.php?id=<?php echo $rowLast["id"]?>" class="post-thumb"> <img src="webadmin/file/portfolio/<?php echo $rowLast['name']?>" class="img-responsive" alt="<?php echo $rowLast["en_title"];?>"></a>
