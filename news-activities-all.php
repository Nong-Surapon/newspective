...
<html lang="en">
    <head>
        ...
        <title>News & Activities all project</title>
        <!-- Bootstrap -->
    ...
    <body class="gray-bg">
        ...
        <div class="inner-page-content">
            <div class="container">
                <div class="row">
                    <?php
                    $newsActivities = newsActivities_All();
                    while ($row = $newsActivities->fetch_assoc()) {
                        ...
                        <div class="col-md-4 col-lg-4">
                            <!-- normal -->
                            <div class="ih-item square effect3 bottom_to_top" style="margin:20px"><a href="news-activities.php?id=<?php echo $row['id'];?>">
                                    <div class="img"><img src="webadmin/file/news/<?php echo newsFileFilst($row['id'])?>"></div>
                                    <div class="info">
