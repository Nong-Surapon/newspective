...
if($_GET["cpn"]=="Newage"){
    $title1 = "Newspective Newage Co.,Ltd.";
    $title2 = "All portfolio";
}else{
    $title1 = "NEWS & ACTIVITIES";
    $title2 = "Newspective Group";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body class="gray-bg">
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text-center">
                    <div class="text-center">
                        <h2 class="center-title"><?php echo $title1;?></h2>
                        <span class="center-border-line"></span>
                        <p class="sub-text"><?php echo $title2;?></p>
                    </div>
                </div>
        ...
        <div class="inner-page-content">
            <div class="container">
                <div class="row">
                    <?php
                    $Aportfolio = information_All($_GET["cpn"]);
                    while ($aport = $Aportfolio->fetch_assoc()) {
                        ...
                        <div class="col-md-4 col-lg-4">
                            <!-- normal -->
                            <div class="ih-item square effect3 bottom_to_top" style="margin:20px"><a href="more.php?id=<?php echo $aport["id"]; ?>">
                                    <div class="img"><img src="webadmin/file/<?php echo $aport["fileNme"]; ?>"></div>
                                    <div class="info">
