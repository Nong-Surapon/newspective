...
<html>
    ...
    <body>
            ...
            <th class="cre text-center">จำนวนเงิน<br>(ที่ใช้จริง)</th>
                                    ...
                                    <div class="col-sm-2">                                       
                                        ...
                                        <div class="checkbox">                                                  
                                            ...
                                            <div id="chk6"><label><input type="checkbox" id="chk_transfer6" name="jobcode_sts" value="6" onchange="return chk_trans6();">รอโอนกลับ</label><br></div>
                                            <div id="chk7"><label><input type="checkbox" id="chk_transfer7" name="jobcode_sts" value="7" onchange="return chk_trans7();">โอนคืนแล้ว</label><br></div>
                                            <div id="chk8"><label><input type="checkbox" id="chk_transfer8" name="jobcode_sts" value="8" onchange="return chk_trans8();">เสร็จสิ้น</label><br></div>
        ...
        <script>
            ...
            function chk_trans7(){                
                if(document.getElementById("chk_transfer7").checked === true){
                    document.getElementById('save').disabled = false;
                }else{
                    document.getElementById('save').disabled = true;
                }
            ...
            function chk_trans8(){                
                if(document.getElementById("chk_transfer8").checked === true){
                    document.getElementById('save').disabled = false;
                }else{
                    document.getElementById('save').disabled = true;
                }
...
//                }
            ...
            function amountTotal(){
                amount = 0;
                amount = document.getElementById('sum3').value;
                if(amount > 1 ){
                    alert('>');
                    //6 รอโอนกลับ
                    document.getElementById("chk6").style.display = "none";
                    document.getElementById("chk7").style.display = "block";
                    ...
                    if(amount == 0){
                        ...
                        document.getElementById("chk8").style.display = "block";
                    }else{
                        document.getElementById("chk6").style.display = "block";
                        document.getElementById("chk7").style.display = "none";
                        document.getElementById("chk8").style.display = "none";
                    }
                }
