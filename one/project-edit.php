      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <button type="reset" value="Reset" class="btn" onclick="location.href='<?php echo $domainName;?>/one/project-list.php'">ย้อนกลับ</button>            
            <br>
            <div id="response"></div>
          </div>
        </div>
...
function send_form()
{
  ...
  if (window.XMLHttpRequest) {
    xmlHTTP_opp = new XMLHttpRequest();
        ...
        xmlHTTP_opp.open('GET', '<?php echo $domainName ?>/one/project-update.php?' + str_param, true);
        xmlHTTP_opp.send(); 
