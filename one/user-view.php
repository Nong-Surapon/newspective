...
<html>
                            ...
                            if (isset($_REQUEST["id"])) {
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div align="center">
                                            <?php if ($user["photo"] == "") { ?>
                                                <img src="profile_photo/defaultProfile.jpg" class="img-thumbnail" width="220" height="250">
                                            <?php } else { ?>
                                                <img src="profile_photo/<?php echo $user["photo"] ?>" class="img-thumbnail" width="220" height="220">
    <?php } ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if ($user["birthday"] != "0000-00-00") {
                                                                echo Thai_date($user["birthday"]);
                                                            } ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="right">จบการศึกษาสูงสุด : </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($user["an_no"] != "") {
                                                            echo "บ้านเลขที่ " . $user["an_no"] . " ";
                                                        }
                                                        if ($user["an_moo"] != "") {
                                                            echo "หมู่ " . $user["an_moo"] . " ";
                                                        }
                                                        if ($user["an_soi"] != "") {
                                                            echo "ซอย " . $user["an_soi"] . " ";
                                                        }
                                                        if ($user["an_road"] != "") {
                                                            echo "ถนน " . $user["an_road"] . " ";
                                                        }
                                                        if ($user["an_tumbon"] != "") {
                                                            echo "แขวง/ตำบล " . $user["an_tumbon"] . " ";
                                                        }
                                                        if ($user["an_amphoe"] != "") {
                                                            echo "เขต/อำเภอ " . $user["an_amphoe"] . " ";
                                                        }
                                                        if ($user["an_province"] != "") {
                                                            echo "จังหวัด " . $user["an_province"] . " ";
                                                        }
                                                        if ($user["an_postcode"] != "") {
                                                            echo "รหัสไปรษณีย์ " . $user["an_postcode"] . " ";
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>        
    ...
    <?php
    if ($user["ah_no"] != "") {
        echo "บ้านเลขที่ " . $user["ah_no"] . " ";
    }
    if ($user["ah_moo"] != "") {
        echo "หมู่ " . $user["ah_moo"] . " ";
    }
    if ($user["ah_soi"] != "") {
        echo "ซอย " . $user["ah_soi"] . " ";
    }
    if ($user["ah_road"] != "") {
        echo "ถนน " . $user["ah_road"] . " ";
    }
    if ($user["ah_tumbon"] != "") {
        echo "แขวง/ตำบล " . $user["ah_tumbon"] . " ";
    }
    if ($user["ah_amphoe"] != "") {
        echo "เขต/อำเภอ " . $user["ah_amphoe"] . " ";
    }
    if ($user["ah_province"] != "") {
        echo "จังหวัด " . $user["ah_province"] . " ";
    }
    if ($user["ah_postcode"] != "") {
        echo "รหัสไปรษณีย์ " . $user["ah_postcode"] . " ";
    }
    ?>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if ($user["workday"] != "0000-00-00") {
                                                        echo $user["workday"];
                                                    } ?></td>
                                                </tr>
                                                <tr>
                                                    <td align="right">เงินเดือน : </td>
                                                    <td><?php if($user["salary"]!="0"){ echo $user["salary"];} ?></td>
                                                </tr>
                                                <tr>
                                                    <td align="right">หมายเหตุ - เพิ่มเติม : </td>
...
?>
                        ...
                        <a href="user-edit.php?id=<?php echo $getID; ?>" class="btn btn-gold"><span class="glyphicon glyphicon-pencil"></span>  Edit</a>
                        <a href="user-del.php?id=<?php echo $getID; ?>" class="btn btn-gold" onclick="return confirm('Are you sure?')"><span class="glyphicon glyphicon-trash"></span>  Delete</a>
...
<?php include_once("footer.php"); ?>
        ...
        <script type="text/javascript">
            ...
            function send_form()
            {
                ...
                xmlHTTP_opp.open('GET', 'http://localhost/newspective/one/user-add.php?' + str_param, true);
                xmlHTTP_opp.send();
