...
$portfolioQurery = newsQurery($_GET["id"]);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="container">
                            ...
                            <div class="blog-content">
                                <div class="entry-media">
                                    <div class="flexslider blog-slider">
                                        <ul class="slides ">
                                            <?php 
                                            $portfolioFile = newsFileID($_GET["id"]);
                                                while ($row = $portfolioFile->fetch_assoc()) {     
                                            ?>
                                            <li>
                                                <img src="webadmin/file/news/<?php echo $row['name']?>" alt="">
                                            </li><!--Single slide li-->
                                            <?php }?>
                ...
                if($len_title > 43){
                    ...
                    $enTitle = $en_title;
                            ...
                            <div class="sidebar-widget">    
                                <a href="news-activities-all.php" class="btn btn-lg btn-block btn-dark-bg">All PROJECT</a>    
                            </div>
                            <div class="sidebar-widget">
